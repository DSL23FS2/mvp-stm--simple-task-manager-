...
class TaskBase(BaseModel):
    ...
    created_at: Optional[datetime] = Field(default=None, description="Дата создания, начала задачи (в формате YYYY-MM-DD)")
    updated_at: Optional[datetime] = Field(default=None, description="Дата окончания, начала задачи (в формате YYYY-MM-DD)")
